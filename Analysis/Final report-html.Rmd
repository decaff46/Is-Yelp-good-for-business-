...
We did a similar analysis by cuisine. And the following is the result : `r phoenix.surviving`. Except for Mexican restaurants, all other cuisines have lower surviving rate than overall surviving rates. With same reason that it is dataset from US, we could understand the situation. 
